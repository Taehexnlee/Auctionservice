...
public class BidsController : ControllerBase
{
    ...
    [Authorize]
    [HttpPost]
    public async Task<ActionResult<BidDtos>> PlaceBid(string auctionId, int amount)
    {
        ...
        return Ok(_mapper.Map<BidDtos>(bid));
    }
    [HttpGet]
    [HttpGet("{auctionId}")]
    public async Task<ActionResult<List<BidDtos>>> GetBidsForAuction(string auctionId)
    {
       ...
       var bids = await DB.Find<Bid>()
        ...
        return bids.Select(_mapper.Map<BidDtos>).ToList();
    }
}
